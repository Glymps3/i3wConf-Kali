...
set cursorcolumn 
:highlight Cursorcolumn cterm=italic ctermbg=green
...
autocmd BufWritePre *.py :%s/\s\+$//e		 " Autoremove trailling whitespace in python files
...
set hlsearch            " Show search highlighs
...
"autocmd InsertCharPre * call CompleteAuto()

" This works for now
autocmd InsertCharPre * call feedkeys("\<C-x>\<C-o>",'n')
